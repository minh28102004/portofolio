...
const ProjectDetails = () => {
  ...
  const projectUrl = getAbsoluteUrl(`/project/${toSlug(project.Title)}`);
        ...
        <meta
          ...
          content={
            project.Description
              ...
              : `Project ${project.Title} by ${profile.fullName} - ${profile.jobTitle}.`
          }
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href={projectUrl} />
        <meta property="og:title" content={`${project.Title} - ${profile.fullName}`} />
              ...
              <div className="space-y-6 md:space-y-10 animate-slideInRight">
                <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl group">
                  ...
                  {project.Img && !hasImageError ? (
                    ...
                    <div className="min-h-[280px] md:min-h-[360px] bg-gradient-to-br from-[#0f172a] via-[#312e81] to-[#4c1d95] p-8 flex flex-col justify-end">
                      <div className="text-sm uppercase tracking-[0.35em] text-indigo-200/70 mb-3">
                        Featured Project
                      </div>
